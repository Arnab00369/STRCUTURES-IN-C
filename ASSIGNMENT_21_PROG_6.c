...
void input(struct Employee *s)
{
    ...
    for(int i=0;i<10;i++)
    {
        ...
        /*if((s[i].name<65&&s[i].name>90)||(s[i].name<97&&s[i]>122))
        {
            printf("ERROR!!!!Employee Name should be Alphabets only");
            exit(0);
        }*/
...
{
    printf("\n\nThe Data of Employees Recorded according to their Names are as follows ::");
    for(int i=0;i<10;i++)
    {
